...
List<ProductsModel> productList = [
  ...
  Product_description: 'Fresh and pure milk from Amul, ideal for daily consumption.',
  Product_rating: 4,
  IsVeg: true,
),
ProductsModel(
  ...
  Product_description: 'Soft and fresh paneer perfect for curries and snacks.',
  Product_rating: 5,
  IsVeg: true,
),
ProductsModel(
...
ProductsModel(
  ...
  Product_price: 140,
  Product_quantity: '200 g',
  Product_description: 'Delicious cheddar cheese slices for sandwiches and snacks.',
  Product_rating: 4,
  IsVeg: true,
),
ProductsModel(
...
ProductsModel(
  ...
  Product_price: 115,
  Product_quantity: '1 L',
  Product_description: 'Blend of multiple fruits for a tasty and healthy drink.',
  Product_rating: 5,
  IsVeg: true,
),
ProductsModel(
...
ProductsModel(
  ...
  Product_price: 35,
  Product_quantity: '250 ml',
  Product_description: 'Traditional Indian summer drink with tangy mango flavor.',
  Product_rating: 5,
  IsVeg: true,
),
...
ProductsModel(
  ...
  Product_price: 30,
  Product_quantity: '1 kg',
  Product_description: 'Fresh and firm potatoes perfect for cooking and baking.',
  Product_rating: 4,
  IsVeg: true,
),
ProductsModel(
...
ProductsModel(
  ...
  Product_price: 180,
  Product_quantity: '500 g',
  Product_description: 'Boneless chicken breast, ideal for grilling and roasting.',
  Product_rating: 4,
  IsVeg: false,
),
ProductsModel(
  ...
  Product_price: 380,
  Product_quantity: '500 g',
  Product_description: 'Tender mutton pieces perfect for rich curry preparations.',
  Product_rating: 5,
  IsVeg: false,
),
ProductsModel(
...
ProductsModel(
  ...
  Product_description: 'Fresh and cleaned prawns, perfect for seafood dishes.',
  Product_rating: 4,
  IsVeg: false,
),
ProductsModel(
