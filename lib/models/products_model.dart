...
Future<void> UploadProductsToFireStore() async {
  ...
  for (final products in productList) {
    ...
    await ProductUpset.set(products.toMap(), SetOptions(merge: true));
    print('Uploaded/Updated: ${products.Product_Name}');
...
List<ProductsModel> productList = [
  ProductsModel(
    ...
    Product_price: 65,
    Product_quantity: '1 L',
    Product_description:
        'Fresh and pure milk from Amul, ideal for daily consumption.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 85,
    Product_quantity: '200 g',
    Product_description:
        'Soft and fresh paneer perfect for curries and snacks.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_description: 'Rich and creamy butter for cooking and spreading.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    Product_Category: 'Dairy',
    Product_Image:
        'assets/images/products/britannia-processed-cheddar-cheese.webp',
    Product_Name: 'Britannia Cheese Slices (200g)',
    Product_price: 140,
    Product_quantity: '200 g',
    Product_description:
        'Delicious cheddar cheese slices for sandwiches and snacks.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_description: 'Creamy and nutritious yogurt from Nestlé.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 320,
    Product_quantity: '500 ml',
    Product_description: 'Pure desi ghee for traditional cooking and flavor.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ...
  ProductsModel(
    ...
    Product_price: 110,
    Product_quantity: '1 L',
    Product_description: 'Refreshing orange juice with no added sugar.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_quantity: '1 L',
    Product_description:
        'Blend of multiple fruits for a tasty and healthy drink.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 20,
    Product_quantity: '1 L',
    Product_description: 'Clean and safe drinking water from Bisleri.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 125,
    Product_quantity: '250 ml',
    Product_description: 'Energy drink to boost performance and alertness.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 45,
    Product_quantity: '180 ml',
    Product_description: 'Chilled coffee beverage for a refreshing break.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_quantity: '250 ml',
    Product_description:
        'Traditional Indian summer drink with tangy mango flavor.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ...
  ProductsModel(
    ...
    Product_price: 175,
    Product_quantity: '500 g',
    Product_description: 'Crunchy corn flakes for a healthy breakfast.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_description: 'Whole grain oats for a nutritious start to the day.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_description: 'Chocolate malt drink mix packed with energy.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 40,
    Product_quantity: '400 g',
    Product_description: 'Soft and healthy whole wheat bread for sandwiches.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 95,
    Product_quantity: '500 g',
    Product_description: 'Instant mix for soft and fluffy idlis.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 75,
    Product_quantity: '190 g',
    Product_description: 'Spicy oats mix for a quick and tasty meal.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ...
  ProductsModel(
    ...
    Product_price: 35,
    Product_quantity: '120 g',
    Product_description: 'Chocolate chip biscuits for a delightful snack.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 50,
    Product_quantity: '90 g',
    Product_description: 'Crispy salted potato chips for anytime munching.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 65,
    Product_quantity: '200 g',
    Product_description: 'Spicy and crunchy Indian snack made from gram flour.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 30,
    Product_quantity: '80 g',
    Product_description: 'Tangy and crispy triangle-shaped chips.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 20,
    Product_quantity: '90 g',
    Product_description: 'Spicy and crunchy corn-based snack.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    Product_Category: 'Snacks',
    Product_Image:
        'assets/images/products/Sunfeast Dark Fantasy Choco Fills.webp',
    Product_Name: 'Sunfeast Dark Fantasy Choco Fills',
    Product_price: 35,
    Product_quantity: '75 g',
    Product_description: 'Soft cookies filled with rich chocolate cream.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ...
  ProductsModel(
    ...
    Product_price: 120,
    Product_quantity: '1 kg',
    Product_description: 'Juicy and sweet apples packed with nutrients.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_description: 'Fresh bananas rich in potassium and fiber.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 35,
    Product_quantity: '1 kg',
    Product_description: 'Fresh red tomatoes ideal for cooking and salads.',
    Product_rating: 3,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_quantity: '1 kg',
    Product_description:
        'Fresh and firm potatoes perfect for cooking and baking.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 25,
    Product_quantity: '1 bunch',
    Product_description: 'Leafy green spinach rich in iron and vitamins.',
    Product_rating: 5,
    IsVeg: true,
  ),
  ProductsModel(
    ...
    Product_price: 90,
    Product_quantity: '500 g',
    Product_description: 'Juicy and sweet green grapes, great for snacking.',
    Product_rating: 4,
    IsVeg: true,
  ),
  ...
  ProductsModel(
    ...
    Product_Image: 'assets/images/products/Chicken Breast.webp',
    Product_Name: 'Chicken Breast (500g)',
    Product_price: 180,
    Product_quantity: '500 g',
    Product_description:
        'Boneless chicken breast, ideal for grilling and roasting.',
    Product_rating: 4,
    IsVeg: false,
  ),
  ProductsModel(
    ...
    Product_quantity: '500 g',
    Product_description:
        'Tender mutton pieces perfect for rich curry preparations.',
    Product_rating: 5,
    IsVeg: false,
  ),
  ProductsModel(
    ...
    Product_price: 160,
    Product_quantity: '500 g',
    Product_description: 'Fresh Rohu fish slices, great for frying or curry.',
    Product_rating: 3,
    IsVeg: false,
  ),
  ProductsModel(
    ...
    Product_price: 220,
    Product_quantity: '250 g',
    Product_description:
        'Fresh and cleaned prawns, perfect for seafood dishes.',
    Product_rating: 4,
    IsVeg: false,
  ),
  ProductsModel(
    ...
    Product_price: 45,
    Product_quantity: '6 pcs',
    Product_description: 'Farm-fresh white eggs, rich in protein.',
    Product_rating: 3,
    IsVeg: false,
  ),
  ProductsModel(
    ...
    Product_price: 150,
    Product_quantity: '250 g',
    Product_description: 'Ready-to-cook chicken sausages with a smoky flavor.',
    Product_rating: 5,
    IsVeg: false,
  ),
];
